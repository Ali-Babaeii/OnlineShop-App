...
export interface renderItemType<T> {
  item: T;
  index: number;
  column: number;
}

export interface getHeightForItem<T> {
  item: T;
  index: number;
}
...
export interface MasonryListProps<T> {
  data: Array<T>;
  numColumns: number;
  renderItem: (params: renderItemType<T>) => React.ReactElement<any>;
  getHeightForItem: (params: getHeightForItem<T>) => number;
...
export interface ColumnsProps<T> {
  numColumns: number;
  data: T[];
  getHeightForItem: (props: getHeightForItem<T>) => number;
}
...
export default function MasonryList<T>({
  ...
  return (
    <ScrollView
      ...
      refreshControl={
        onRefresh && <RefreshControl refreshing={false} onRefresh={onRefresh} />
      }>
